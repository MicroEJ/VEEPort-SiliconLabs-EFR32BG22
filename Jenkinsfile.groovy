...
buildWithAnt{
	...
	ANT_PROPERTIES = "-Declipse.home=c:/jenkinsTools/common/microej/eclipse/microej-sdk-20.10/win64"				// The properties run with ant. Default value is already set. Add specific properties if necessary. As ('-DnameOfProperties=valueofProperty').
